    ...
    <form action="{{route('products.store')}}" method="POST" class="p-6" enctype="multipart/form-data">
        ...
        <div class="container-place w-full sm:w-[80%] grid grid-cols-1 gap-2 bg-white rounded-lg p-6">
            ...
            <div class="col-span-1 mt-5">
                <button type="submit" class="w-full bg-brand hover:bg-brand-strong text-white font-medium py-2.5 px-6 cursor-pointer rounded-base w-full sm:w-auto transition-all shadow-md shadow-brand/20"><i class="fas fa-add"></i> Create Product</button>
            </div>
        </div>
