...
@section('navbar')
    <div class="navbar-container flex items-center justify-between w-full gap-4 pe-6">
        <h1 class="text-lg md:text-3xl font-bold">CATEGORIES <span class="text-base text-gray-400">> Edit {{$category->nama}}</span></h1>
...
@section('container')
    ...
    <form action="{{route('categories.update',$category->uuid)}}" method="POST" class="p-6">
        @method('put')
        @csrf
        <div class="container-place w-full sm:w-[80%] grid grid-cols-1 gap-2 bg-white rounded-lg p-6">
            ...
            <div class="col-span-1 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-12 gap-2">
                ...
                {{-- icon list --}}
                <div class="col-span-1">
                    <input type="radio" id="icon-apple-whole" name="icon" value="fa-apple-whole" class="hidden peer" @if(old('icon', $category->icon) == 'fa-apple-whole') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-bread-slice" name="icon" value="fa-bread-slice" class="hidden peer" @if(old('icon', $category->icon) == 'fa-bread-slice') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-burger" name="icon" value="fa-burger" class="hidden peer" @if(old('icon', $category->icon) == 'fa-burger') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-seedling" name="icon" value="fa-seedling" class="hidden peer" @if(old('icon', $category->icon) == 'fa-seedling') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-blender" name="icon" value="fa-blender" class="hidden peer" @if(old('icon', $category->icon) == 'fa-blender') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-beer-mug-empty" name="icon" value="fa-beer-mug-empty" class="hidden peer" @if(old('icon', $category->icon) == 'fa-beer-mug-empty') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-bottle-water" name="icon" value="fa-bottle-water" class="hidden peer" @if(old('icon', $category->icon) == 'fa-bottle-water') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-bowl-rice" name="icon" value="fa-bowl-rice" class="hidden peer" @if(old('icon', $category->icon) == 'fa-bowl-rice') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-cake-candles" name="icon" value="fa-cake-candles" class="hidden peer" @if(old('icon', $category->icon) == 'fa-cake-candles') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-cheese" name="icon" value="fa-cheese" class="hidden peer" @if(old('icon', $category->icon) == 'fa-cheese') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-cookie" name="icon" value="fa-cookie" class="hidden peer" @if(old('icon', $category->icon) == 'fa-cookie') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-ice-cream" name="icon" value="fa-ice-cream" class="hidden peer" @if(old('icon', $category->icon) == 'fa-ice-cream') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-mug-hot" name="icon" value="fa-mug-hot" class="hidden peer" @if(old('icon', $category->icon) == 'fa-mug-hot') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-pizza-slice" name="icon" value="fa-pizza-slice" class="hidden peer" @if(old('icon', $category->icon) == 'fa-pizza-slice') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-lemon" name="icon" value="fa-lemon" class="hidden peer" @if(old('icon', $category->icon) == 'fa-lemon') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-wine-glass" name="icon" value="fa-wine-glass" class="hidden peer" @if(old('icon', $category->icon) == 'fa-wine-glass') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="icon-bowl-food" name="icon" value="fa-bowl-food" class="hidden peer" @if(old('icon', $category->icon) == 'fa-bowl-food') checked @endif>
            ...
            <div class="col-span-1 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-12 gap-2">
                ...
                {{-- Color list --}}
                <div class="col-span-1">
                    <input type="radio" id="color-red-500" name="color" value="bg-red-500" class="hidden peer" @if(old('color', $category->color) == 'bg-red-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-red-300" name="color" value="bg-red-300" class="hidden peer" @if(old('color', $category->color) == 'bg-red-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-red-100" name="color" value="bg-red-100" class="hidden peer" @if(old('color', $category->color) == 'bg-red-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-blue-500" name="color" value="bg-blue-500" class="hidden peer" @if(old('color', $category->color) == 'bg-blue-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-blue-300" name="color" value="bg-blue-300" class="hidden peer" @if(old('color', $category->color) == 'bg-blue-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-blue-100" name="color" value="bg-blue-100" class="hidden peer" @if(old('color', $category->color) == 'bg-blue-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-green-500" name="color" value="bg-green-500" class="hidden peer" @if(old('color', $category->color) == 'bg-green-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-green-300" name="color" value="bg-green-300" class="hidden peer" @if(old('color', $category->color) == 'bg-green-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-green-100" name="color" value="bg-green-100" class="hidden peer" @if(old('color', $category->color) == 'bg-green-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-yellow-500" name="color" value="bg-yellow-500" class="hidden peer" @if(old('color', $category->color) == 'bg-yellow-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-yellow-300" name="color" value="bg-yellow-300" class="hidden peer" @if(old('color', $category->color) == 'bg-yellow-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-yellow-100" name="color" value="bg-yellow-100" class="hidden peer" @if(old('color', $category->color) == 'bg-yellow-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-lime-500" name="color" value="bg-lime-500" class="hidden peer" @if(old('color', $category->color) == 'bg-lime-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-lime-300" name="color" value="bg-lime-300" class="hidden peer" @if(old('color', $category->color) == 'bg-lime-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-lime-100" name="color" value="bg-lime-100" class="hidden peer" @if(old('color', $category->color) == 'bg-lime-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-indigo-500" name="color" value="bg-indigo-500" class="hidden peer" @if(old('color', $category->color) == 'bg-indigo-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-indigo-300" name="color" value="bg-indigo-300" class="hidden peer" @if(old('color', $category->color) == 'bg-indigo-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-indigo-100" name="color" value="bg-indigo-100" class="hidden peer" @if(old('color', $category->color) == 'bg-indigo-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-violet-500" name="color" value="bg-violet-500" class="hidden peer" @if(old('color', $category->color) == 'bg-violet-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-violet-300" name="color" value="bg-violet-300" class="hidden peer" @if(old('color', $category->color) == 'bg-violet-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-violet-100" name="color" value="bg-violet-100" class="hidden peer" @if(old('color', $category->color) == 'bg-violet-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-sky-500" name="color" value="bg-sky-500" class="hidden peer" @if(old('color', $category->color) == 'bg-sky-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-sky-300" name="color" value="bg-sky-300" class="hidden peer" @if(old('color', $category->color) == 'bg-sky-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-sky-100" name="color" value="bg-sky-100" class="hidden peer" @if(old('color', $category->color) == 'bg-sky-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-pink-500" name="color" value="bg-pink-500" class="hidden peer" @if(old('color', $category->color) == 'bg-pink-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-pink-300" name="color" value="bg-pink-300" class="hidden peer" @if(old('color', $category->color) == 'bg-pink-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-pink-100" name="color" value="bg-pink-100" class="hidden peer" @if(old('color', $category->color) == 'bg-pink-100') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-amber-500" name="color" value="bg-amber-500" class="hidden peer" @if(old('color', $category->color) == 'bg-amber-500') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-amber-300" name="color" value="bg-amber-300" class="hidden peer" @if(old('color', $category->color) == 'bg-amber-300') checked @endif>
                ...
                <div class="col-span-1">
                    <input type="radio" id="color-amber-100" name="color" value="bg-amber-100" class="hidden peer" @if(old('color', $category->color) == 'bg-amber-100') checked @endif>
            ...
            <div class="col-span-1 mt-5">
                <button type="submit" class="w-full bg-brand-light hover:bg-brand-strong text-white font-medium py-2 px-4 cursor-pointer rounded-base w-full sm:w-auto"><i class="fas fa-edit"></i> Edit Categories</button>
            </div>
        </div>
